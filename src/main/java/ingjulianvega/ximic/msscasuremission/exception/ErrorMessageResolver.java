...
import ingjulianvega.ximic.msscasuremission.configuration.RemissionParameters;
...
public class ErrorMessageResolver {
    ...
    private final RemissionParameters remissionParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(remissionParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(remissionParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
