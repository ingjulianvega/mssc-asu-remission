...
public class ErrorCodeMessages {
    ...
    public static final String REMISSION_NOT_FOUND_API_CODE = "401";
    public static final String REMISSION_NOT_FOUND_ERROR = "REMISSION_NOT_FOUND";
    public static final String REMISSION_NOT_FOUND_MESSAGE = "No se encontró la remisión";
    public static final String REMISSION_NOT_FOUND_SOLUTION = "Verifique los datos";
